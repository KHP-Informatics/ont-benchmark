...
#SBATCH --chdir /scratch/prj/ppn_als_longread/jobs/A081_91_sup
...
nextflow run epi2me-labs/wf-human-variation \
    ...
    --bam /scratch/prj/ppn_als_longread/basecalled/A081_91_sup \
    --out_dir /scratch/prj/ppn_als_longread/vcf/A081_91_sup \

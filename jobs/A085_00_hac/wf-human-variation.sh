...
#SBATCH --job-name=A085_00_hac_wf-human-variation
...
#SBATCH --chdir /scratch/prj/ppn_als_longread/jobs/A085_00_hac
...
nextflow run epi2me-labs/wf-human-variation \
    ...
    --bam /scratch/prj/ppn_als_longread/basecalled/A085_00_hac \
    --out_dir /scratch/prj/ppn_als_longread/vcf/A085_00_hac \
    --sample_name A085_00_hac \
    --sex female \

...
#SBATCH --chdir /scratch/prj/ppn_als_longread/jobs/A157_02_sup
...
nextflow run epi2me-labs/wf-human-variation \
    ...
    --bam /scratch/prj/ppn_als_longread/basecalled/A157_02_sup \
    --out_dir /scratch/prj/ppn_als_longread/vcf/A157_02_sup \

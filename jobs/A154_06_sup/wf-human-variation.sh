...
#SBATCH --chdir /scratch/prj/ppn_als_longread/jobs/A154_06_sup
...
nextflow run epi2me-labs/wf-human-variation \
    ...
    --bam /scratch/prj/ppn_als_longread/basecalled/A154_06_sup \
    --out_dir /scratch/prj/ppn_als_longread/vcf/A154_06_sup \

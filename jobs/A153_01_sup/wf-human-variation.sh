...
#SBATCH --chdir /scratch/prj/ppn_als_longread/jobs/A153_01_sup
...
nextflow run epi2me-labs/wf-human-variation \
    ...
    --bam /scratch/prj/ppn_als_longread/basecalled/A153_01_sup \
    --out_dir /scratch/prj/ppn_als_longread/vcf/A153_01_sup \

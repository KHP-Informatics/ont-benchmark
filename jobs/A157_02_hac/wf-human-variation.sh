...
#SBATCH --job-name=A157_02_hac_wf-human-variation
...
#SBATCH --chdir /scratch/prj/ppn_als_longread/jobs/A157_02_hac
...
nextflow run epi2me-labs/wf-human-variation \
    ...
    --bam /scratch/prj/ppn_als_longread/basecalled/A157_02_hac \
    --out_dir /scratch/prj/ppn_als_longread/vcf/A157_02_hac \
    --sample_name A157_02_hac \
    --sex male \

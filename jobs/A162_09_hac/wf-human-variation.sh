...
#SBATCH --job-name=A162_09_hac_wf-human-variation
...
#SBATCH --chdir /scratch/prj/ppn_als_longread/jobs/A162_09_hac
...
nextflow run epi2me-labs/wf-human-variation \
    ...
    --bam /scratch/prj/ppn_als_longread/basecalled/A162_09_hac \
    --out_dir /scratch/prj/ppn_als_longread/vcf/A162_09_hac \
    --sample_name A162_09_hac \
    --sex female \

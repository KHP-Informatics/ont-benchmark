...
#SBATCH --job-name=A079_07_hac_wf-human-variation
...
#SBATCH --chdir /scratch/prj/ppn_als_longread/jobs/A079_07_hac
...
nextflow run epi2me-labs/wf-human-variation \
    ...
    --bam /scratch/prj/ppn_als_longread/basecalled/A079_07_hac \
    --out_dir /scratch/prj/ppn_als_longread/vcf/A079_07_hac \
    --sample_name A079_07_hac \
    --sex male \

...
#SBATCH --chdir /scratch/prj/ppn_als_longread/jobs/A097_92_sup
...
nextflow run epi2me-labs/wf-human-variation \
    ...
    --bam /scratch/prj/ppn_als_longread/basecalled/A097_92_sup \
    --out_dir /scratch/prj/ppn_als_longread/vcf/A097_92_sup \

...
#SBATCH --job-name=A160_96_hac_wf-human-variation
...
#SBATCH --chdir /scratch/prj/ppn_als_longread/jobs/A160_96_hac
...
nextflow run epi2me-labs/wf-human-variation \
    ...
    --bam /scratch/prj/ppn_als_longread/basecalled/A160_96_hac \
    --out_dir /scratch/prj/ppn_als_longread/vcf/A160_96_hac \
    --sample_name A160_96_hac \
    --sex female \

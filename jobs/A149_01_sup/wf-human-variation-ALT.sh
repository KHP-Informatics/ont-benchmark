...
#SBATCH --job-name=A149_01_sup_ALT_wf-human-variation
...
#SBATCH --chdir /scratch/prj/ppn_als_longread/jobs/A149_01_sup
...
nextflow run epi2me-labs/wf-human-variation \
    ...
    --bam /scratch/prj/ppn_als_longread/basecalled/A149_01_sup \
    --out_dir /scratch/prj/ppn_als_longread/vcf/A149_01_sup_ALT \
    --sample_name A149_01_sup_ALT \
    --sex male \
    --basecaller_cfg dna_r10.4.1_e8.2_400bps_sup@v4.3.0 \
    --ref /scratch/prj/ppn_als_longread/references_old/hg38.fa
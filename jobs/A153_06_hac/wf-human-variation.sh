...
#SBATCH --job-name=A153_06_hac_wf-human-variation
...
#SBATCH --chdir /scratch/prj/ppn_als_longread/jobs/A153_06_hac
...
nextflow run epi2me-labs/wf-human-variation \
    ...
    --bam /scratch/prj/ppn_als_longread/basecalled/A153_06_hac \
    --out_dir /scratch/prj/ppn_als_longread/vcf/A153_06_hac \
    --sample_name A153_06_hac \
    --sex female \

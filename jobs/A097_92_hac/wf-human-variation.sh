...
#SBATCH --job-name=A097_92_hac_wf-human-variation
...
nextflow run epi2me-labs/wf-human-variation \
    ...
    --bam /scratch/prj/ppn_als_longread/basecalled/A097_92_hac \
    --out_dir /scratch/prj/ppn_als_longread/vcf/A097_92_hac \

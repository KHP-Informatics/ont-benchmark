...
#SBATCH --job-name=A160_96_sup_wf-basecalling
...
#SBATCH --chdir /scratch_tmp/prj/ppn_als_longread/wf-basecalling/jobs/ont-benchmark/A160_96_sup
...
nextflow run epi2me-labs/wf-basecalling \
    ...
    --input /scratch_tmp/prj/ppn_als_longread/wf-basecalling/pod5/ont-benchmark/A160_96 \
    --out_dir /scratch_tmp/prj/ppn_als_longread/wf-basecalling/basecalled/A160_96_sup \

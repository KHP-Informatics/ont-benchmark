...
#SBATCH --job-name=A160_96_sup_wf-human-variation
...
#SBATCH --chdir /scratch_tmp/prj/ppn_als_longread/wf-human-variation/jobs/ont-benchmark/A160_96_sup
...
nextflow run epi2me-labs/wf-human-variation \
    ...
    --bam /scratch_tmp/prj/ppn_als_longread/wf-basecalling/basecalled/A160_96_sup \
    --out_dir /scratch_tmp/prj/ppn_als_longread/wf-human-variation/vcf/A160_96_sup \

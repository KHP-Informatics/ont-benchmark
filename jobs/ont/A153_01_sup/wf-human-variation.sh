...
#SBATCH --job-name=A153_01_sup_wf-human-variation
...
#SBATCH --chdir /scratch_tmp/prj/ppn_als_longread/wf-human-variation/jobs/ont-benchmark/A153_01_sup
...
nextflow run epi2me-labs/wf-human-variation \
    ...
    --bam /scratch_tmp/prj/ppn_als_longread/wf-basecalling/basecalled/A153_01_sup \
    --out_dir /scratch_tmp/prj/ppn_als_longread/wf-human-variation/vcf/A153_01_sup \

...
#SBATCH --job-name=A153_01_sup_wf-basecalling
...
#SBATCH --chdir /scratch_tmp/prj/ppn_als_longread/wf-basecalling/jobs/ont-benchmark/A153_01_sup
...
nextflow run epi2me-labs/wf-basecalling \
    ...
    --input /scratch_tmp/prj/ppn_als_longread/wf-basecalling/pod5/ont-benchmark/A153_01 \
    --out_dir /scratch_tmp/prj/ppn_als_longread/wf-basecalling/basecalled/A153_01_sup \
    --sample_name A153_01_sup \

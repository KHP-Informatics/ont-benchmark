...
#SBATCH --job-name=A153_06_sup_wf-basecalling
...
#SBATCH --chdir /scratch_tmp/prj/ppn_als_longread/wf-basecalling/jobs/ont-benchmark/A153_06_sup
...
nextflow run epi2me-labs/wf-basecalling \
    ...
    --input /scratch_tmp/prj/ppn_als_longread/wf-basecalling/pod5/ont-benchmark/A153_06 \
    --out_dir /scratch_tmp/prj/ppn_als_longread/wf-basecalling/basecalled/A153_06_sup \

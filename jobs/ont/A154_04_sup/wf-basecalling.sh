...
#SBATCH --job-name=A154_04_sup_wf-basecalling
...
#SBATCH --chdir /scratch_tmp/prj/ppn_als_longread/wf-basecalling/jobs/ont-benchmark/A154_04_sup
...
nextflow run epi2me-labs/wf-basecalling \
    ...
    --input /scratch_tmp/prj/ppn_als_longread/wf-basecalling/pod5/ont-benchmark/A154_04 \
    --out_dir /scratch_tmp/prj/ppn_als_longread/wf-basecalling/basecalled/A154_04_sup \
    --sample_name A154_04_sup \

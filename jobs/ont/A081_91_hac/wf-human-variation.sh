...
#SBATCH --job-name=A081_91_hac_wf-human-variation
...
#SBATCH --chdir /scratch/prj/ppn_als_longread/jobs/A081_91_hac
...
nextflow run epi2me-labs/wf-human-variation \
    ...
    --bam /scratch/prj/ppn_als_longread/basecalled/A081_91_hac \
    --out_dir /scratch/prj/ppn_als_longread/vcf/A081_91_hac \
    --sample_name A081_91_hac \
    --sex female \

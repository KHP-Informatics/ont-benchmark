...
#SBATCH --job-name=A154_06_sup_wf-basecalling
...
#SBATCH --chdir /scratch_tmp/prj/ppn_als_longread/wf-basecalling/jobs/ont-benchmark/A154_06_sup
...
nextflow run epi2me-labs/wf-basecalling \
    ...
    --input /scratch_tmp/prj/ppn_als_longread/wf-basecalling/pod5/ont-benchmark/A154_06 \
    --out_dir /scratch_tmp/prj/ppn_als_longread/wf-basecalling/basecalled/A154_06_sup \
    --sample_name A154_06_sup \

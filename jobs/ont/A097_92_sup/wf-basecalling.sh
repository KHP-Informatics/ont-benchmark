...
#SBATCH --job-name=A097_92_sup_wf-basecalling
...
#SBATCH --chdir /scratch_tmp/prj/ppn_als_longread/wf-basecalling/jobs/ont-benchmark/A097_92_sup
...
nextflow run epi2me-labs/wf-basecalling \
    ...
    --input /scratch_tmp/prj/ppn_als_longread/wf-basecalling/pod5/ont-benchmark/A097_92 \
    --out_dir /scratch_tmp/prj/ppn_als_longread/wf-basecalling/basecalled/A097_92_sup \
    --sample_name A097_92_sup \

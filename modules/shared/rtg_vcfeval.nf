...
process RTG_VCFEVAL {
    ...
    publishDir "${params.outdir}/snv/rtg_vcfeval/${region_type}", mode: 'copy'
    ...
    path "${rtg_dir}/${sample_id}_${file_type}_${region_type}_weighted_roc.tsv.gz", emit: weighted_roc
    ...
    script:
    rtg_dir = "${sample_id}.${file_type}.${region_type}"
    """
    ...
    mv ${rtg_dir}/weighted_roc.tsv.gz ${rtg_dir}/${sample_id}_${file_type}_${region_type}_weighted_roc.tsv.gz
    """
}
